          ...
          "
                >
                    ...
                    <div className="md:col-span-5">
                        ...
                        {/* small preview card like on screenshot */}
                        <div
                            className="
              ...
              "
                        >
                            <div className="absolute inset-0">
                                ...
                                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(0,0,0,0.10),rgba(0,0,0,0.90))]" />
                                <div className="absolute -left-24 top-1/2 h-[420px] w-[420px] -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(255,170,90,0.18),rgba(255,170,90,0)_60%)] blur-3xl" />
                            </div>
